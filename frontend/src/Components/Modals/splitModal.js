...
function SplitModal({ open, classes, handleClose, splitHandler }) {
                        ...
                        <Grid container className={classes.root} >
                            <Grid item xs={12}>
                                <Grid container justify="space-evenly" al spacing={2}>
                                    ...
                                    <Grid item>
                                        <TextField id="outlined-basic" label="Split Position" variant="outlined" onChange={(event) => {
                                ...
                                <Grid container justify="center" spacing={2}>
                                    <Grid item>
                                        <Button variant="outlined" color="primary" component="span" onClick={() => {
                                            splitHandler(start, end, position)
                                        }}>
                                            Split
                                        </Button>
                                    </Grid>
